...
For more information about Ansible content, see xref:platform/con-gs-create-automation-content.adoc[Create automation content] in xref:assembly-gs-auto-dev[Getting started as an automation developer].
